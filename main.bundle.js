...
module.exports = "<h1>\n  {{title}}\n  <button (click)=\"bClicked()\" >Start Show Hide</button>\n  <!--<h1 *ngIf=\"bShow\">Information1111</h1>-->\n  <h1 style.color=\"{{v}}\" >Information2</h1>\n\n  <br/>\n  <input type=\"text\" [value]=\"age\" (input)=\"valChanged()\">\n  <img [src]=\"picUrl\" />\n  <input >\n</h1>\n\n "
...
var AppComponent = (function () {
    function AppComponent() {
        ...
        this.bShow = false;
        this.age = 100;
        this.picUrl = "http://lorempixel.com/400/200/";
    }
    AppComponent.prototype.Constructor = function () {
    };
    AppComponent.prototype.bClicked = function () {
        var _this = this;
        setInterval(function () {
            _this.bShow = !_this.bShow;
            _this.age++;
            if ((_this.age % 2) != 0) {
                _this.picUrl = "http://lorempixel.com/400/200/?";
            }
            else {
                _this.picUrl = "http://lorempixel.com/400/200";
            }
    ...
    AppComponent.prototype.valChanged = function () {
        this.age = 0;
    };
    AppComponent.prototype.visib = function () {
        if ((this.age % 2) != 0) {
            this.v = "red";
        }
        else {
